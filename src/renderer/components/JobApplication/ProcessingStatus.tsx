...
function ProcessingStatus({ aiState, onCancel }: ProcessingStatusProps): React.JSX.Element {
  ...
  return (
    <div className="processing-status">
      <div className="processing-status__content">
        ...
        <p className="processing-status__message">{aiState.statusMessage || getDefaultMessage()}</p>
        ...
        <span className="processing-status__progress-text">{aiState.progress}%</span>
        <button type="button" className="processing-status__cancel-btn" onClick={onCancel}>
          Cancel
        </button>
      </div>
    </div>
